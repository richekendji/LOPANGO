...
export default async function AdminPage() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h1 className="text-lg font-bold text-zinc-900">Tableau de bord</h1>
        <p className="mt-1 text-sm text-zinc-500">
          Comptes, paiements et fiches utilisateurs.
        </p>
      </div>

      <div className="grid grid-cols-3 gap-2">
        <StatCard label="Comptes" value={stats.total} />
        <StatCard label="Payé" value={stats.paid} tone="paid" />
        <StatCard label="Non payé" value={stats.unpaid} />
      </div>
